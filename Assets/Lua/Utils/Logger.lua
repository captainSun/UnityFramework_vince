...
--- Created by sunshuo.
--- DateTime: 2023/9/20 17:29
---
local xpcall = xpcall
local traceback = debug.traceback
local unpack = unpack

local log = VinceFramework.Logger.Log
local logWarning = VinceFramework.Logger.LogWarning
local logError = VinceFramework.Logger.LogError
local logNet = VinceFramework.Logger.LogNet
...
function Logger.SetUncaughtExceptionHandler(callback)
    ...
    VinceFramework.Logger.SetUncaughtExceptionHandler(callback)
end
